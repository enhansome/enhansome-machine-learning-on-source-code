...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,723 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 - MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code.
...
* [NL2Bash](https://github.com/TellinaTool/nl2bash) ⭐ 518 | 🐛 12 | 🌐 NewLisp | 📅 2026-09-02 - This dataset contains a set of \~10,000 bash one-liners collected from websites such as StackOverflow and their English descriptions written by Bash programmers, as described in the [paper](https://arxiv.org/abs/1802.08979).
...
* Inspired by [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,302 | 🐛 34 | 🌐 Python | 📅 2026-09-08.
