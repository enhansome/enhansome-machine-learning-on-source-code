# Awesome Machine Learning On Source Code with stars
...
* [CodRep](https://github.com/KTH/CodRep-competition) ⭐ 94 | 🐛 12 | 📅 2019-07-21 - competition on automatic program repair: given a source line, find the insertion point.
...
* <img src="badges/12-pages-gray.svg" alt="12-pages" align="top"> [ClDiff: Generating Concise Linked Code Differences](https://chenbihuan.github.io/paper/ase18-huang-cldiff.pdf) - Kaifeng Huang, Bihuan Chen, Xin Peng, Daihong Zhou, Ying Wang, Yang Liu, Wenyun Zhao, ASE 2018. [Code](https://github.com/FudanSELab/CLDIFF) ⭐ 40 | 🐛 1 | 🌐 Java | 📅 2022-06-04.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,772 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - MindsDB is an Explainable AutoML framework for developers. With MindsDB you can build, train and use state of the art ML models in as simple as one line of code.
...
* [Differentiable Neural Computer (DNC)](https://github.com/deepmind/dnc) ⭐ 2,532 | 🐛 9 | 🌐 Python | 📅 2021-07-23 - TensorFlow implementation of the Differentiable Neural Computer.
...
* [DeepSim](https://github.com/parasol-aser/deepsim) ⭐ 66 | 🐛 8 | 🌐 Python | 📅 2019-06-11 - a deep learning-based approach to measure code functional similarity.
* [gemini](https://github.com/src-d/gemini) ⭐ 58 | 🐛 30 | 🌐 Scala | 📅 2019-06-06 - Source code deduplication as scale, production.
...
* [Code Neuron](https://github.com/vmarkovtsev/codeneuron) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2018-12-10 - Recurrent neural network to detect code blocks in natural language text.
* [rnn-autocomplete](https://github.com/ZeRoGerc/rnn-autocomplete) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2019-05-19 - Neural code autocompletion with RNN (bachelor's thesis).
...
* [source{d} models](https://github.com/src-d/models) ⭐ 19 | 🐛 5 | 📅 2019-10-30 - Machine Learning models for MLonCode trained using the source{d} stack.
...
* [NL2Bash](https://github.com/TellinaTool/nl2bash) ⭐ 519 | 🐛 12 | 🌐 NewLisp | 📅 2026-09-02 - This dataset contains a set of \~10,000 bash one-liners collected from websites such as StackOverflow and their English descriptions written by Bash programmers, as described in the [paper](https://arxiv.org/abs/1802.08979).
...
* Inspired by [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,454 | 🐛 20 | 🌐 Python | 📅 2026-09-22.

## Contributions

See [CONTRIBUTING.md](CONTRIBUTING.md). TL;DR: create a [pull request](https://github.com/src-d/awesome-machine-learning-on-source-code/pulls) ⭐ 6,640 | 🐛 8 | 📅 2020-12-03 which is [signed off](https://github.com/src-d/awesome-machine-learning-on-source-code/blob/master/CONTRIBUTING.md#certificate-of-origin) ⭐ 6,640 | 🐛 8 | 📅 2020-12-03.
